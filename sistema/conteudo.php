            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">CONTEÚDOS PARA ESTUDO</h1>
                    </div>
                    <hr>
                    <div class="card text-center">
                        <div class="card-header">
                            <h5 class="card-title">CONTEÚDO DE MÍDIA</h5>
                        </div>
                        <div class="card-body">
                           <!--<img src="../img/video.png" height="60" width="70">-->
                           <iframe width="200" height="100" src="https://www.youtube.com/embed/j8eVeB18dvM" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
                           </iframe>
                           <iframe width="200" height="100" src="https://www.youtube.com/embed/Sg7NT-Ab7eA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>
                          </iframe>
                        </div>
                    </div><br>
                    <div class="card text-center">
                        <div class="card-header">
                            <h5 class="card-title">CONTEÚDO DE TEXTO</h5>
                        </div>
                        <div class="card-body">
                           <img src="../img/conteudo.png" height="60" width="70">
                        </div>
                    </div><br>
                    <div class="card text-center">
                        <div class="card-header">
                        ...
                        <div class="card-body">
                           <img src="../img/exercicio.png" height="60" width="70">
                        </div>
                    </div>                    
                </div>
            </div>
