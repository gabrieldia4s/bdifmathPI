            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800"> EMENTA - MATEMÁTICA II</h1>
                    </div>
                    <hr>
                    <ol class="list-group list-group-numbered">
                      <li class="list-group-item d-flex justify-content-between align-items-start">
                        <div class="ms-2 me-auto">
                          <a href="conteudo.php"><div class="fw-bold">Sequências numéricas:</div></a>
                            <p class="text-justify"><small>Conceituação de sequências aritméticas e geométricas (progressões aritméticas e geométricas) com ênfase na resolução de problemas relacionados com as funções afim e exponencial.
                            </small></p>
                        </div>
                      </li>
                      <li class="list-group-item d-flex justify-content-between align-items-start">
                        <div class="ms-2 me-auto">
                          <a href="conteudo.php"><div class="fw-bold">Matemática financeira:</div></a>
                            <p class="text-justify"><small>Porcentagem, juros, descontos. Deve-se mostrar juros compostos como uma aplicação dos logaritmos.
                            </small></p>
                        </div>
                      </li>
                      <li class="list-group-item d-flex justify-content-between align-items-start">
                        <div class="ms-2 me-auto">
                          <a href="conteudo.php"><div class="fw-bold">Matrizes:</div></a>
                            <p class="text-justify"><small>Conceituação e operações com matrizes. Deve-se explorar as matrizes em aplicações práticas e como ferramenta para o estudo dos sistemas lineares. Determinantes de ordem 2 e 3.
                            </small></p>
                        </div>
                      </li>
                      <li class="list-group-item d-flex justify-content-between align-items-start">
                        <div class="ms-2 me-auto">
                          <a href="conteudo.php"><div class="fw-bold">Sistemas lineares:</div></a>
                            <p class="text-justify"><small>Conceituação e resolução de problemas envolvendo sistemas lineares com ênfase na resolução por escalonamento. Deve-se também explorar a solução geométrica de um sistema linear como introdutório à Geometria Analítica.
                            </small></p>
                        </div>
                      </li>
                      <li class="list-group-item d-flex justify-content-between align-items-start">
                        <div class="ms-2 me-auto">
                          <a href="conteudo.php"><div class="fw-bold">Trigonometria:</div></a>
                            <p class="text-justify"><small>Estudo do ciclo trigonométrico e das funções trigonométricas com ênfase nas funções seno, cosseno e tangente. Deve-se ter uma atenção especial ao estudo das funções expressas por f(x) = a + bsen (cx + d) e das relações trigonométricas básicas. Recomenda-se a interface com o estudo das identidades, transformações, equações e inequações trigonométricas de forma superficial. 
                            </small></p>
                        </div>
                      </li>
                      <li class="list-group-item d-flex justify-content-between align-items-start">
                        <div class="ms-2 me-auto">
                          <a href="conteudo.php"><div class="fw-bold">Números complexos:</div></a>
                            <p class="text-justify"><small> Histórico, conceituação, representação gráfica e operações com números complexos na forma algébrica. O estudo na forma trigonométrica pode ser explorado superficialmente.
                            </small></p>
                        </div>
                      </li>
