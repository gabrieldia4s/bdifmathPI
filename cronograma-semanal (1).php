            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">CRONOGRAMA DE ESTUDO SEMANAL</h1>
                    </div>
                    <hr>
                        <form >
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                <label for="inputDia" class="form-label">Dia da Semana</label>
                                <select class="form-select" aria-label="Default select example">
