...
<!doctype html>
  ...
  <head>
    ...
    <title>Página de Login Administrativo</title>
    ...
    <div class="container">
      <div class="d-flex justify-content-center h-100">
        ...
        <?php 
          ...
          <div class="card-body">
            <form name="form" method="POST" action="validacao/logar_adm.php">
              <div class="input-group form-group">
                <div class="input-group-prepend">
                  <span class="input-group-text"><i class="fas fa-user"></i></span>
                </div>
                <input type="text" class="form-control" name="matricula" placeholder="Digite seu Login" autofocus required>
              </div>
              <div class="input-group form-group">
                <div class="input-group-prepend">
              ...
              <div class="form-group">
                <button type="submit" class="btn btn-md btn-block btn-success"><i class="fa fa-sign-in" aria-hidden="true"></i> Entrar </button>
              </div>
            </form>
          </div>
        </div>
